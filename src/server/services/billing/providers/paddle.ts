...
export class PaddleProvider implements PaymentProvider, SubscriptionProvider, BillingProvider, InvoiceProvider {
  async createCustomer(email: string, name?: string): Promise<{ id: string }> {
    throw new Error("Paddle billing is not implemented yet.");
  }
...
ProviderRegistry.registerPaymentProvider("paddle", paddle);
ProviderRegistry.registerSubscriptionProvider("paddle", paddle);
ProviderRegistry.registerBillingProvider("paddle", paddle);
ProviderRegistry.registerInvoiceProvider("paddle", paddle);
