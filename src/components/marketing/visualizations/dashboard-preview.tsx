...
export function DashboardPreview() {
 ...
 {item.badge && (
 <span className={`hidden xl:inline-block px-space-2 py-space-0.5 radius-md text-caption font-mono leading-none font-bold relative z-10 transition-colors ${
 ...
 <span className="text-caption text-muted-foreground uppercase tracking-wider font-semibold mt-space-1 truncate">Admin</span>
 </div>
 </div>
 ...
 <span className="text-caption font-mono leading-none bg-black/5 dark:bg-white/10 px-space-1.5 py-space-1 radius-md border border-border-subtle shrink-0 text-foreground/70">⌘K</span>
 </div>
 </div>
 ...
 <span className="text-caption font-semibold text-muted-foreground uppercase tracking-widest">{stat.label}</span>
 ...
 <svg className="absolute inset-space-0 h-full w-full text-primary" viewBox="0 0 6 3" preserveAspectRatio="none">
 <defs>
 ...
 points={stat.sparkline.map((val, i) => `${i},${3 - (val / Math.max(...stat.sparkline)) * 2.2}`).join(" ")}
 />
 </svg>
 </div>
 </div>
 ...
 <span className="text-caption font-mono bg-black/5 dark:bg-white/10 px-space-2 py-space-0.5 radius-md font-semibold">4 active</span>
 </div>

 {/* List Container - Premium Scroll */}
 <div className="space-y-space-3 overflow-y-hidden max-h-128 pr-space-2 hide-scroll pb-space-4">
 {calls.map((call, idx) => {
 ...
 <span className={`px-space-2 py-space-0.5 radius-md text-caption font-normal uppercase tracking-widest shrink-0 border ${
 call.status ==="Booked"
 ...
 <span className="font-mono whitespace-nowrap text-caption">{call.phone}</span>
 <span className="opacity-40 select-none text-caption">•</span>
 <span className="font-semibold text-foreground/70 truncate text-caption">{call.type}</span>
 </div>
 </div>
 </div>
 ...
 <span className="text-caption text-muted-foreground font-mono truncate font-medium bg-black/5 dark:bg-white/10 px-space-2 py-space-0.5 radius-md">{selectedCall.phone}</span>
 </div>
 <p className="text-caption text-muted-foreground mt-space-1.5 whitespace-nowrap uppercase tracking-widest">Interaction Ref: <span className="font-mono text-primary font-semibold tracking-wider ml-space-1">#NEXX-{selectedCall.id}29-A</span></p>
 </div>
 ...
 <ScrollArea className="flex-1 p-space-6 space-y-space-8 max-h-full relative z-10" horizontal={false}>
                                  ...
                                  <span className="text-caption font-mono text-muted-foreground font-semibold">1:42</span>
                                  </div>
                                  </div>
                                  </div>
                                  ...
                                  <p className="text-body-sm font-semibold text-foreground leading-none">{step.title}</p>
                                  <p className="text-caption text-muted-foreground mt-space-1.5 leading-snug font-medium">{step.desc}</p>
                                  </div>
                                  </div>
                                  ))}
                                  </div>
                                  ...
                                  <div className={`h-7 w-7 radius-md flex items-center justify-center font-normal text-caption border shrink-0 ${
                                  bubble.speaker ==="ai"
                                  ...
                                  <div className={`radius-2xl px-space-5 py-space-3 text-body-sm leading-relaxed backdrop-blur-md ${
                                  bubble.speaker ==="ai"
 ...
 <span className="text-caption font-semibold text-muted-foreground uppercase tracking-widest shrink-0">System Sync</span>
 ...
 <span className="text-caption font-semibold text-foreground/80">{integration.name}</span>
 <span className="text-caption text-muted-foreground font-medium bg-black/5 dark:bg-black/20 px-space-2 py-space-0.5 radius-md uppercase tracking-wider">{integration.status}</span>
 </div>
 ))}
 </div>
 </div>
 ...
 <ScrollArea className="grid grid-cols-1 gap-space-4 max-h-136 pr-space-2 pb-space-4" horizontal={false}>
                              ...
                              <div>
                              <div className="flex items-center gap-space-3">
                              <span className="text-body-sm font-semibold text-foreground">{chat.sender}</span>
                              <span className="text-caption radius-md bg-white/80 dark:bg-white/10 border border-border-default px-space-2.5 py-space-0.5 text-muted-foreground font-semibold tracking-widest uppercase">{chat.source}</span>
                              </div>
                              <p className="text-body-sm text-muted-foreground mt-space-1.5 leading-snug font-medium max-w-lg">{chat.msg}</p>
                              </div>
                              </div>
                              <div className="flex sm:flex-col items-center sm:items-end justify-between sm:justify-center gap-space-2 shrink-0">
                              <span className="text-caption font-semibold text-emerald-600 dark:text-emerald-400 bg-emerald-500/15 border border-emerald-500/30 px-space-3 py-space-1.5 radius-md uppercase tracking-wider">{chat.status}</span>
                              <span className="text-caption text-muted-foreground font-mono mt-space-1 font-semibold">{chat.time}</span>
                              </div>
                              </div>
                              ))}
                              </ScrollArea>
 ...
 {activeTab ==="calendar"&& (
 <ScrollArea className="space-y-space-6 flex-1 max-h-136 pr-space-2 animate-in fade-in slide-in-from-bottom-space-4 duration-700 ease-out pb-space-4" horizontal={false}>
                          ...
                          <p className="text-caption text-muted-foreground mt-space-1 font-medium">Real-time slot alignment checking configured across Google & Outlook</p>
                          </div>
                          <span className="text-caption font-semibold text-foreground bg-white/80 dark:bg-white/10 border border-border-default px-space-4 py-space-2 radius-xl font-mono self-start sm:self-auto backdrop-blur-md">Friday, July 9, 2026</span>
                          </div>

                          <div className="grid grid-cols-7 gap-space-3 text-center">
                          {["Mon","Tue","Wed","Thu","Fri","Sat","Sun"].map((d) => (
                          <div key={d} className="text-caption font-semibold text-muted-foreground uppercase tracking-widest py-space-2">{d}</div>
                          ))}
                          ...
                          >
                          <span>{d}</span>
                          {d === 9 && <span className="text-caption uppercase tracking-widest opacity-90 font-sans font-semibold bg-white/20 px-space-2 py-space-0.5 radius-md">Today</span>}
                          ...
                          <p className="text-caption font-semibold uppercase tracking-widest text-muted-foreground px-space-1 mb-space-4">AI Reserved Slots Today</p>
                          {[
                          ...
                          <div className="flex items-center gap-space-5">
                          <span className="text-body-sm font-mono font-semibold text-primary w-16 shrink-0">{slot.time}</span>
                          <div className={`h-10 w-10 radius-xl flex items-center justify-center font-semibold text-caption border shrink-0 ${slot.color}`}>
                          {slot.avatar}
                          </div>
                          <div>
                          <p className="text-body-sm font-semibold text-foreground leading-none group-hover:text-primary transition-colors">{slot.client}</p>
                          <p className="text-caption text-muted-foreground mt-space-1.5 font-medium">{slot.type}</p>
                          </div>
                          </div>
 ...
 <ScrollArea className="space-y-space-6 flex-1 max-h-136 pr-space-2 animate-in fade-in slide-in-from-bottom-space-4 duration-700 ease-out pb-space-4" horizontal={false}>
                          ...
                          <p className="text-caption text-muted-foreground mt-space-1 font-medium">Automated savings and capturing rates analysis</p>
                          </div>
                          <span className="text-caption font-semibold text-muted-foreground uppercase tracking-widest font-mono bg-white/80 dark:bg-white/10 border border-border-default px-space-4 py-space-2 radius-xl backdrop-blur-md">July 2026 REPORT</span>
                          </div>
                          ...
                          <p className="relative z-10 text-caption font-semibold text-muted-foreground uppercase tracking-widest mb-space-3">{card.label}</p>
                          <p className="relative z-10 text-3xl text-foreground font-mono font-black leading-none py-space-2">{card.value}</p>
                          <p className="relative z-10 text-caption text-primary font-semibold mt-space-2 leading-snug">{card.desc}</p>
                          <p className="relative z-10 text-caption text-muted-foreground mt-space-4 border-t border-border-subtle pt-space-3 font-semibold">{card.sub}</p>
                          </div>
                          ))}
                          </div>
                          ...
                          <div>
                          <span className="text-body-sm font-semibold text-foreground">Weekly Revenue Recovered</span>
                          <p className="text-caption text-muted-foreground mt-space-1 font-medium">Recovered from missed incoming leads</p>
                          </div>
                          ...
                          {[1,2,3,4].map(i => <div key={i} className="w-full h-px bg-black/5 dark:bg-white/5"/>)}
                          </div>
                          ...
                          <span className="text-caption font-semibold text-muted-foreground font-mono tracking-widest bg-black/5 dark:bg-white/10 px-space-2 py-space-1 radius-md">WK {idx + 1}</span>
                          </div>
                          ))}
                          </div>
                          </div>
