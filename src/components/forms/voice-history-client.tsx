...
export function VoiceHistoryClient({ initialSessions }: { initialSessions: any[] }) {
 ...
 case"completed":
 return (
 <span className="badge-status badge-success text-caption px-space-1.5 py-space-0.5 rounded flex items-center gap-space-1">
 ...
 case"failed":
 return (
 <span className="badge-status badge-error text-caption px-space-1.5 py-space-0.5 rounded flex items-center gap-space-1">
 ...
 case"voicemail":
 return (
 <span className="badge-status badge-warning text-caption px-space-1.5 py-space-0.5 rounded flex items-center gap-space-1">
 ...
 case"transferred":
 return (
 <span className="badge-status badge-primary text-caption px-space-1.5 py-space-0.5 rounded flex items-center gap-space-1">
 ...
 default:
 return (
 <span className="badge-status badge-info text-caption px-space-1.5 py-space-0.5 rounded flex items-center gap-space-1 animate-pulse">
 ...
 <span className="inline-flex items-center gap-space-1.5 text-caption font-medium text-indigo-600 dark:text-indigo-400">
 <ArrowDownLeft className="h-3.5 w-3.5"/>
 Inbound
 </span>
 ) : (
 <span className="inline-flex items-center gap-space-1.5 text-caption font-medium text-emerald-600 dark:text-emerald-400">
 ...
 <SheetContent className="sm:max-w-md bg-card border-l border-[hsl(var(--foreground)/0.08)] flex flex-col justify-between overflow-y-auto pr-space-3">
 <div>
 ...
 {/* Tab Navigation */}
 <div className="flex border-b border-[hsl(var(--foreground)/0.06)] bg-[hsl(var(--foreground)/0.005)] p-space-0.5 radius-lg">
 {(["summary","transcript","events"] as const).map((tab) => (
 <Button
 key={tab}
 onClick={() => setActiveTab(tab)}
 className={cn(
 "flex-1 text-center py-space-1.5 text-caption font-normal uppercase tracking-wider radius-md transition-all cursor-pointer",
 activeTab === tab
 ...
 <div className="space-y-space-3.5 max-h-96 overflow-y-auto pr-space-1 sidebar-scroll">
 ...
 {activeTab ==="events"&& (
 <div className="space-y-space-3 pl-space-2 max-h-96 overflow-y-auto sidebar-scroll">
 ...
 <Button variant="ghost"onClick={() => setIsSheetOpen(false)} className="text-caption font-semibold h-8.5 rounded-lg hover:bg-[hsl(var(--foreground)/0.05)] cursor-pointer">
