...
> = {
  businessInfo: { icon: Building2, label: "Business Info", href: "/profile", color: "text-primary", iconBg: "bg-primary/10" },
  services:     { icon: Package,   label: "Services",      href: "/services", color: "text-primary",                          iconBg: "bg-primary/10" },
  staff:        { icon: Users,     label: "Staff",          href: "/staff",    color: "text-[hsl(var(--state-info-text))]",        iconBg: "bg-[hsl(var(--state-info-bg))]" },
  documents:    { icon: FileText,  label: "Knowledge",     href: "/kb",       color: "text-[hsl(var(--state-success-text))]",iconBg: "bg-[hsl(var(--state-success-bg))]" },
  integrations: { icon: Plug,      label: "Integrations",  href: "/channels", color: "text-[hsl(var(--state-warning-text))]",   iconBg: "bg-[hsl(var(--state-warning-bg))]" },
};
