...
>(({ className, interactive, ...props }, ref) => (
 ...
 ref={ref}
 className={cn(
 "radius-lg border border-border-default bg-card text-card-foreground transition-all duration-200",
 interactive &&"cursor-pointer hover:border-border-hover active:scale-[0.995]",
