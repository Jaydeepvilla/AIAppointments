...
function ToastItem({ toast, onDismiss }: { toast: Toast; onDismiss: () => void }) {
 ...
 className="text-caption font-medium text-primary hover:underline cursor-pointer mt-space-1"
 >
 {toast.action.label}
 </button>
 )}
 ...
 className="shrink-0 radius-md p-space-1 text-muted-foreground/40 transition-all duration-150 hover:text-foreground hover:bg-[hsl(var(--foreground)/0.06)] cursor-pointer active:scale-90"
 >
