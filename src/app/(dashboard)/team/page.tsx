...
export default function TeamPage() {
 ...
 className="h-8.5 text-caption font-semibold text-white cursor-pointer gap-space-1.5 shrink-0 rounded-full px-space-4"
 >
 ...
 {successBanner && (
 <div className="flex items-center gap-space-2 rounded-full bg-state-success-bg border border-state-success-text/15 px-space-4 py-space-2.5 text-caption text-state-success-text shrink-0 animate-fade-in">
 <Check className="h-4 w-4 shrink-0"/>
 <span className="flex-1 font-medium">{successBanner}</span>
 <Button 
 className="hover:opacity-70 transition-opacity font-semibold px-space-1 text-body-sm cursor-pointer"
 ...
 <div className="flex gap-space-1.5 overflow-x-auto w-full sm:w-auto pb-space-1 sm:pb-0 scrollbar-none">
 {[
 ...
 {/* Members Table */}
 <div className="overflow-x-auto w-full bg-[hsl(var(--foreground)/0.002)]">
 <table className="w-full text-left text-caption divide-y divide-[hsl(var(--foreground)/0.06)]">
 <thead className="bg-[hsl(var(--foreground)/0.015)] uppercase text-[11px] font-semibold text-muted-foreground/55 tracking-wider sticky top-0 z-10 border-b border-[hsl(var(--foreground)/0.06)]">
 <tr>
 ...
 <span
 className={cn(
 "inline-flex items-center gap-space-1.5 rounded-full border px-space-2.5 py-space-0.5 text-[10px] font-normal uppercase tracking-wider",
 ...
 className="h-8.5 text-caption rounded-full"
 >
 Cancel
 </Button>
 <Button 
 ...
 size="sm"
 disabled={inviting}
 className="min-w-28 bg-primary hover:bg-primary-light h-8.5 text-caption rounded-full"
 >
 {inviting ? (
 <>
