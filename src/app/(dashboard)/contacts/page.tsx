...
export default function ContactsPage() {
 ...
 {/* Contacts Table List */}
 <div className="flex-1 overflow-auto bg-[hsl(var(--foreground)/0.002)]">
 ...
 <th className="p-space-3">Conversations</th>
 ...
 <td className="p-space-3 text-muted-foreground/80 flex items-center gap-space-1 mt-space-1.5 border-none">
 ...
 >
 <Edit className="h-3.5 w-3.5 text-muted-foreground/60"/>
 </Button>
 </td>
 </tr>
 );
