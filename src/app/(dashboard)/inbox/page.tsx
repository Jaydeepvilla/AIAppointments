...
export default function UnifiedInboxPage() {
 ...
 <span>{st}</span>
 <span className="text-caption bg-foreground/5 px-space-1.5 py-space-0.25 radius-md font-normal">
 {count}
 </span>
 </TabsTrigger>
 );
 ...
 <div className="flex items-center gap-space-2 font-medium text-neutral-600 ">
 ...
 <Inbox className="h-8 w-8 text-neutral-300 mb-space-2 animate-float" />
 ...
 : isAi
 ? "bg-primary-50 border-primary/10 text-foreground rounded-tr-none"
 ...
 'filled',
 'medium',
 'hover:scale-110 p-1 text-body-sm cursor-pointer text-center transition-all'
 )}
 onClick={() => {
 ...
 {/* Caption Footer */}
 <div className="text-[10px] text-neutral-400 uppercase font-semibold tracking-wider text-right border-t border-border-subtle pt-1 shrink-0">
 ...
 <span className="truncate max-w-xs text-neutral-700 font-medium">
 📎 {attachment.name}
 </span>
 <Button
 variant="ghost"
 ...
 <div className="h-8 w-8 radius-full bg-neutral-100 border border-border-subtle flex items-center justify-center text-neutral-400">
