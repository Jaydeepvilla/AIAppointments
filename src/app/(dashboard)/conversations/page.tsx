...
export default function ConversationsPage() {
 ...
 switch (status) {
 case"active":
 return <span className="badge-status badge-success text-caption px-space-1.5 py-space-0.5 rounded">Active</span>;
 case"escalated":
 ...
 switch (status) {
 case"New":
 return <span className="badge-status badge-info text-caption px-space-1.5 py-space-0.25 scale-90">New</span>;
 case"Qualified":
 return <span className="badge-status badge-success text-caption px-space-1.5 py-space-0.25 scale-90">Qualified</span>;
 case"Hot":
 return <span className="badge-status badge-warning text-caption px-space-1.5 py-space-0.25 scale-90">Hot</span>;
 case"Escalated":
 return <span className="badge-status badge-error text-caption px-space-1.5 py-space-0.25 scale-90">Escalated</span>;
 default:
 return <span className="badge-status badge-neutral text-caption px-space-1.5 py-space-0.25 scale-90">{status}</span>;
 }
 };
 ...
 size="icon"
 variant="ghost"
 className="h-8 w-8 radius-full hover:bg-[hsl(var(--foreground)/0.05)] cursor-pointer"
 onClick={loadList}
 ...
 <span className="inline-flex items-center gap-space-1 rounded bg-[hsl(var(--foreground)/0.04)] border border-[hsl(var(--foreground)/0.05)] px-space-2.5 py-space-0.75 text-caption text-muted-foreground/75 font-semibold uppercase tracking-wider">
 System: {msg.content}
 </span>
 </div>
 );
 ...
 <div key={idx} className="bg-[hsl(var(--foreground)/0.02)] border border-[hsl(var(--foreground)/0.04)] rounded p-space-2 text-caption text-muted-foreground/85 leading-snug">
 ...
 <div key={evt.id} className="flex justify-center items-center gap-space-1.5 my-space-2.5 text-caption text-muted-foreground/80 bg-[hsl(var(--foreground)/0.02)] border border-[hsl(var(--foreground)/0.04)] py-space-1 px-space-3.5 radius-full w-fit mx-auto">
 ...
 type="submit"
 size="sm"
 className="h-8.5 px-space-3 font-semibold"
 disabled={sendingMessage || !testMessage.trim() || activeDetails.conversation.status ==="closed"}
 >
 {sendingMessage ? (
