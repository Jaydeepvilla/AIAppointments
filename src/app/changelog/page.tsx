  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden">
        ...
        <div className="dot-grid absolute inset-0 grid-fade-b opacity-40" />
      </div>

      <main className="relative z-10">
        {/* Hero */}
        <section className="container mx-auto max-w-3xl px-space-6 pt-space-28 pb-space-16 text-center">
          <div className="inline-flex items-center gap-space-2 radius-full border border-[hsl(var(--foreground)/0.08)] bg-[hsl(var(--foreground)/0.03)] px-space-3 py-space-1 text-caption  tracking-widest text-muted-foreground uppercase mb-space-6">
        ...
        <section className="container mx-auto max-w-4xl px-space-6 pb-space-24">
          <div className="relative">
            {/* Timeline line */}
            <div className="absolute left-space-2 top-space-3 bottom-0 w-px bg-[hsl(var(--foreground)/0.08)] hidden sm:block" />
        ...
        <section className="border-t border-[hsl(var(--foreground)/0.06)] bg-[hsl(var(--foreground)/0.02)] py-space-16">
          <div className="container mx-auto max-w-2xl px-space-6 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-space-2 justify-center max-w-sm mx-auto">
              ...
              />
              <Button className="radius-lg bg-primary px-space-5 py-space-2 text-body-sm  text-primary-foreground hover:bg-primary/90 transition-colors duration-150 whitespace-nowrap">
                Subscribe
              </Button>
            </div>
          </div>
